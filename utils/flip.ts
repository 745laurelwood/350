...
/**
 * FLIP-based cross-browser transition. Captures positions of all
 * [data-card-id] elements, commits the React state change synchronously,
 * then animates any element that moved from its old rect to its new rect.
 */
